...
module "intranet_justice_gov_uk_records" {
  ...
  records = [
    ...
    }, 
    {
      ...
      ttl  = 900
      records = [
        "ns-63.awsdns-07.com. awsdns-hostmaster.amazon.com. 1 7200 900 1209600 86400"
      ]
    }, 
    {
      name = "intranet.justice.gov.uk."
    ...
    {
      name = "_asvdns-25d85fcb-1a2c-4908-ad39-316862907964.intranet.intranet.justice.gov.uk."
      type = "TXT"
      ttl  = 300
      records = [
        "asvdns_54feda94-a0af-419c-9834-6422eb969cdc"
      ]
    }, 
    {
