module "service_justice_gov_uk" {
  ...
  records = [
    ...
    {
      name = "stack.5c52051d.prisoners-api-prod.service.justice.gov.uk."
      type = "TXT"
      ttl  = 60
      records = [
        "5c52051d"
    ...
    {
      name = "stack.91fc489b.prisoners-api-prod.service.justice.gov.uk."
      type = "TXT"
      ttl  = 60
      records = [
        "91fc489b"
    ...
    {
      name = "stack.9bee1354.prisoners-api-prod.service.justice.gov.uk."
      type = "TXT"
      ttl  = 60
      records = [
        "9bee1354"
    ...
    {
      name = "stack.9c9c92a0.prisoners-api-prod.service.justice.gov.uk."
      type = "TXT"
      ttl  = 60
      records = [
        "9c9c92a0"
    ...
    {
      name = "stack.a0756fba.prisoners-api-prod.service.justice.gov.uk."
      type = "TXT"
      ttl  = 60
      records = [
        "a0756fba"
    ...
    {
      name = "stack.active.prisoners-api-prod.service.justice.gov.uk."
      type = "TXT"
      ttl  = 60
      records = [
        "9bee1354"
    ...
    {
      name = "stack.ae93d6fa.prisoners-api-prod.service.justice.gov.uk."
      type = "TXT"
      ttl  = 60
      records = [
        "ae93d6fa"
    ...
    {
      name = "deployarn.91fc489b.prod.prisoners-api.service.justice.gov.uk."
      type = "TXT"
      ttl  = 60
      records = [
        "arn:aws:iam::880656497252:role/prisoners-api-prod-91fc489b-CrossAccountRole-9XZ9QWKQBJG1"
      ]
    },
    {
      name = "deployarn.9bee1354.prod.prisoners-api.service.justice.gov.uk."
      type = "TXT"
      ttl  = 60
      records = [
        "arn:aws:iam::880656497252:role/prisoners-api-prod-9bee1354-CrossAccountRole-1TCDUQ8TVJT3E"
      ]
    },
    {
      name = "deployarn.active.prod.prisoners-api.service.justice.gov.uk."
      type = "TXT"
      ttl  = 60
      records = [
        "arn:aws:iam::880656497252:role/prisoners-api-prod-9bee1354-CrossAccountRole-1TCDUQ8TVJT3E"
