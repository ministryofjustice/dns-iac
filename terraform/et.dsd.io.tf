module "et_dsd_io" {
  ...
  records = [
    ...
    },
    {
      ...
      ttl  = 60
      records = [
        "arn:aws:iam::880656497252:role/atet-dev-08b7c382-CrossAccountRole-ZLMPZM1GPCVG"
      ]
    },
    {
    ...
    },
    {
      ...
      ttl  = 60
      records = [
        "arn:aws:iam::880656497252:role/atet-prod-7289c8be-CrossAccountRole-MSFWGHQP9553"
      ]
    },
    {
      ...
      ttl  = 60
      records = [
        "arn:aws:iam::880656497252:role/atet-staging-dabf48a8-CrossAccountRole-198E61KE3TPHJ"
      ]
    },
    {
    ...
    },
    {
      ...
      ttl  = 300
      records = [
        "arn:aws:iam::903817190142:role/et3-dev-cf12aa9d-CrossAccountRole-2N158VO2OZ3H"
      ]
    },
    {
      ...
      ttl  = 300
      records = [
        "arn:aws:iam::903817190142:role/et3-staging-1c015dc2-CrossAccountRole-17WEXKMN4N6C"
      ]
    },
    {
