...
moved {
  from = module.rpts_gov_uk.aws_route53_record.default
  to   = module.rpts_gov_uk_records.aws_route53_record.this
}

moved {
  from = module.rpts_gov_uk.aws_route53_zone.default
  to   = module.rpts_gov_uk_zone.aws_route53_zone.this
}
