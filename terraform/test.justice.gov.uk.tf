...
module "test_justice_gov_uk_records" {
  ...
  records = [
    ...
    }, 
    {
      ...
      ttl  = 900
      records = [
        "ns-590.awsdns-09.net. awsdns-hostmaster.amazon.com. 1 7200 900 1209600 86400"
      ]
    }, 
    {
      name = "test.justice.gov.uk."
    ...
    {
      name = "_asvdns-7a292a7c-bf2c-4a06-9417-6e2bd96615f0.test.justice.gov.uk."
      type = "TXT"
      ttl  = 300
      records = [
        "asvdns_1123468c-9669-48a3-bb3c-2c9ca0d16107"
      ]
    }, 
    {
